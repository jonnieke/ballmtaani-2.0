...
const AdminEdgePage = React.lazy(() => import("./pages/edge/AdminEdgePage"));
const ExecutiveDashboardPage = React.lazy(() => import("./pages/edge/ExecutiveDashboardPage"));
const LaunchCommandCenterPage = React.lazy(() => import("./pages/edge/LaunchCommandCenterPage"));
const InvestorDashboardPage = React.lazy(() => import("./pages/edge/InvestorDashboardPage"));
const PartnershipPipelinePage = React.lazy(() => import("./pages/edge/PartnershipPipelinePage"));
const ExpansionScorecardsPage = React.lazy(() => import("./pages/edge/ExpansionScorecardsPage"));
const ScaledOperationsDashboardPage = React.lazy(() => import("./pages/edge/ScaledOperationsDashboardPage"));
const ScaleProgrammesPage = React.lazy(() => import("./pages/edge/ScaleProgrammesPage"));
const PartnerApplicationsPage = React.lazy(() => import("./pages/edge/PartnerApplicationsPage"));
const SelfServicePartnersPage = React.lazy(() => import("./pages/edge/SelfServicePartnersPage"));
const B2bBillingPage = React.lazy(() => import("./pages/edge/B2bBillingPage"));
const UsageLedgerPage = React.lazy(() => import("./pages/edge/UsageLedgerPage"));
const CustomerSuccessPage = React.lazy(() => import("./pages/edge/CustomerSuccessPage"));
const SalesOperationsPage = React.lazy(() => import("./pages/edge/SalesOperationsPage"));
const RegionalMarketsPage = React.lazy(() => import("./pages/edge/RegionalMarketsPage"));
const PaymentProvidersPage = React.lazy(() => import("./pages/edge/PaymentProvidersPage"));
const PortfolioOptimizationPage = React.lazy(() => import("./pages/edge/PortfolioOptimizationPage"));
const RevenueRetentionPage = React.lazy(() => import("./pages/edge/RevenueRetentionPage"));
const CapitalAllocationPage = React.lazy(() => import("./pages/edge/CapitalAllocationPage"));
const SportOpportunitiesPage = React.lazy(() => import("./pages/edge/SportOpportunitiesPage"));
const MarketplaceAdminPage = React.lazy(() => import("./pages/edge/MarketplaceAdminPage"));
const SellerApplicationsPage = React.lazy(() => import("./pages/edge/SellerApplicationsPage"));
const CorporateRecordsPage = React.lazy(() => import("./pages/edge/CorporateRecordsPage"));
const CapTablePage = React.lazy(() => import("./pages/edge/CapTablePage"));
const IpRegisterPage = React.lazy(() => import("./pages/edge/IpRegisterPage"));
const InvestorPipelinePage = React.lazy(() => import("./pages/edge/InvestorPipelinePage"));
const DiligenceRoomPage = React.lazy(() => import("./pages/edge/DiligenceRoomPage"));
const ExitReadinessPage = React.lazy(() => import("./pages/edge/ExitReadinessPage"));
const StrategicTransactionsPage = React.lazy(() => import("./pages/edge/StrategicTransactionsPage"));

function EdgeAdminRoutes() {
  return (
    <AdminLayout>
      <React.Suspense fallback={<div className="p-8 text-sm text-white/60">Loading admin workspace...</div>}>
        <Switch>
          ...
          <div className="min-h-screen bg-[#0A0A0A] text-white flex flex-col font-sans selection:bg-[#B30000] selection:text-white">
            ...
            <main className="flex-grow">
              <Switch>
                ...
                <Route path="/admin/edge" component={EdgeAdminRoutes} />
                <Route path="/admin/edge/:rest*" component={EdgeAdminRoutes} />
