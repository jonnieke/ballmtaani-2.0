...
import { ArrowRight, Smartphone, ShieldCheck, Heart, Gift } from "lucide-react";
...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Read ?ref= param and store for post-login bonus
    ...
    <div className="min-h-screen bg-[#0B0B0B] flex flex-col items-center justify-center p-4 relative overflow-hidden text-white">
      ...
      <div className="w-full max-w-md bg-[#1A1A1A]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 relative z-10 shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          {referralFrom && (
            <div className="mt-3 inline-flex items-center gap-2 bg-[#FFD700]/10 border border-[#FFD700]/30 rounded-full px-4 py-1.5">
              <Gift className="w-4 h-4 text-[#FFD700]" />
              <span className="text-[#FFD700] font-black text-xs uppercase tracking-widest">You'll earn 500 MTC on signup!</span>
            </div>
          )}
        </div>
