        ...
        <div className="rounded-2xl border border-white/10 overflow-hidden shadow-2xl mb-8 bg-[#1B1B1B]">
          ...
          <div className="p-8 relative overflow-hidden" style={{ backgroundColor: zone.color }}>
            ...
            <div className="relative z-10 flex items-end gap-6">
              <div className="w-20 h-20 rounded-full bg-white flex items-center justify-center text-4xl font-black shadow-xl" style={{ color: zone.color }}>
                {zone.team[0]}
              </div>
              <div className="pb-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {FAN_ZONES.map(zone => (
          <div key={zone.id} className="bg-[#1B1B1B] rounded-xl border border-white/5 shadow-xl relative overflow-hidden group hover:border-white/20 transition-all hover:-translate-y-1">
            <div className="h-16 w-full opacity-20" style={{ backgroundColor: zone.color }}></div>
            
            <div className="p-5 relative">
              <div 
                className="absolute -top-10 left-5 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-black text-white shadow-lg border-4 border-[#1B1B1B]" 
