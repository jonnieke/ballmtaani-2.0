    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-white/10 bg-black/95 backdrop-blur-xl px-4 py-3 shadow-[0_-4px_20px_rgba(0,0,0,0.6)]">
      <div className="mx-auto flex max-w-lg items-center gap-3">
        <div className="flex-1 min-w-0">
          <p className="text-xs font-black text-white uppercase tracking-wider">WC26 is live</p>
          <p className="text-[10px] text-white/40">Lock your prediction before kickoff. Keep the receipt.</p>
        </div>
